				...
				<div class="row">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							...
							<input type="number" class="form-control form-control-sm" name="experience" required value="<?php echo isset($experience) ? $experience : '' ?>">
							
						</div><div class="form-group">
							<label class="control-label">Ratings</label>
							<input type="number" class="form-control form-control-sm" name="ratings" required value="<?php echo isset($ratings) ? $ratings : '' ?>">
...
<script>
	...
	$('#manage_user').submit(function(e){
		...
		error: function(xhr, status, error) {
			...
			alert_toast('Error occurred while processing the request.', "error");
			end_load();
		}
});
